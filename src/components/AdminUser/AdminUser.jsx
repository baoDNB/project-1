  ...
  const renderAction = () => {
    return (
      <div>
        ...
        <EditOutlined style={{ color: 'green', fontSize: '30px', cursor: 'pointer' }} onClick={handleDetailsProduct} />
      </div>
    )
  }
      ...
      <DrawerComponent title='Chi tiết người dùng' isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)} width="70%">
        <Loading isLoading={isLoadingUpdate || isLoadingUpdated}>
          ...
          >
            ...
            >
              <InputComponent value={stateProductUserDetails?.email} onChange={handleOnchangeDetails} name="email" />
            </Form.Item>
            <Form.Item
              label="Phone"
              name="phone"
            ...
            >
              <WrapperUploadFile onChange={handleOnchangeAvatarDetails} maxCount={1} showUploadList={false} >
                ...
                {stateProductUserDetails?.avatar && (
                  <img
                    src={stateProductUserDetails?.avatar}
                    style={{
                      height: '60px',
                      width: '60px',
                      borderRadius: '50%',
