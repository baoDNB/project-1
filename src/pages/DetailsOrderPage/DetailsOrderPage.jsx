...
import { orderSlice } from '../../redux/silces/orderSilce';
...
const DetailsOrderPage = () => {
    ...
    const queryOrder = useQuery({
        queryKey: ['order-details'], queryFn: fetchDetailsOrder, enabled: !!id
    })
                    ...
                    {data?.orderItems?.map((order) => {
                        return (
                            <WrapperProduct>
                                ...
                                <WrapperItem>{order?.discount ? convertPrice(priceMemo * order?.discount / 100) : '0VNĐ'}</WrapperItem>
